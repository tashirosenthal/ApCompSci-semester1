public class Magpie2
{
	...
	{
		String list = statement.trim().toLowerCase();
		String lastChar = list.substring(list.length() - 1);
		if(lastChar.equals("."))
		{
			list = list.substring(0, list.length() - 1);
		}
		int psnOfI= findKeyword(list, "I" , 0);
		int psnOfYou = findKeyword(list, "Me", psnOfI);
		String restOfStatement =  list.substring(psnOfI + 1);
		return "Why do you" + restOfStatement + " like me?";
